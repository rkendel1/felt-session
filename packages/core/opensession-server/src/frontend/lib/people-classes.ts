 ...
 *  a scroll affordance. */
export const PEOPLE_CHIP_ROW = mergeStylexClassName("", sx.mb6, sx.flex, sx.flexWrap, sx.itemsCenter, sx.gap15);

/** One scope: everyone, a person, or an organization. */
export const PEOPLE_CHIP =
	mergeStylexClassName("", sx.focusRing, sx.inlineFlex, sx.minW0, sx.cursorPointer, sx.itemsCenter, sx.gap2, sx.rounded999px) + " " +
	mergeStylexClassName("", sx.border0, sx.bgPanel, sx.py1, sx.pr3, sx.pl1, typography.controlLabel, sx.fontMedium, sx.textDim) + " " +
	mergeStylexClassName("", sx.transitionColors, sx.durationVarDurMicro, sx.easeVarEase) + " " +
...
export const PEOPLE_CHIP_SELECTED =
	mergeStylexClassName("", sx.bgAccent, sx.fontSemibold, sx.textOnAccent, sx.hoverBgAccentHover, sx.hoverTextOnAccent);

/** The glyph slot in a chip that has no face of its own (Everyone). */
export const PEOPLE_CHIP_GLYPH =
	mergeStylexClassName("", sx.flex, sx.size26px, sx.shrink0, sx.itemsCenter, sx.justifyCenter, sx.roundedAvatar, sx.bgHover, sx.textDim);
...
export const PEOPLE_SECTION_LABEL = mergeStylexClassName("", sx.m0, sx.mb2, typography.body, sx.fontSemibold, sx.textFg);
