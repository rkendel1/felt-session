...
export const plainEntryRow = mergeStylexClassName("", sx.flex, sx.flexCol, sx.gap1);

/** A message from the customer. No surface: this is the page's content, not a
 *  card on it. */
export const plainEntryIn = mergeStylexClassName("", sx.flex, sx.flexCol, sx.gap1);
...
export const plainEntryNote = mergeStylexClassName("", sx.flex, sx.flexCol, sx.gap1, sx.rounded2xl, sx.px4, sx.py3);
...
export const plainEntryHead = mergeStylexClassName("", sx.flex, sx.flexWrap, sx.itemsBaseline, sx.gapX2, sx.gapY05);

/** Who spoke. */
export const plainEntryName = mergeStylexClassName("", typography.supporting, sx.fontSemibold, sx.textFg);

/** Channel and time, in one faint run: two separate spans read as two facts
 *  when they are one aside. */
export const plainEntryMeta = mergeStylexClassName("", typography.meta, sx.textFaint);
...
export const plainEntryBody =
	mergeStylexClassName("markdown", sx.breakWords, typography.body, sx.leadingRelaxed, sx.textFg) + " " +
