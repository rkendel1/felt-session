...
export const SETTING_ROW =
	mergeStylexClassName("", sx.flex, sx.wFull, sx.itemsCenter, sx.gap3, sx.roundedMd, sx.px2, sx.py2, sx.phonePy3, sx.textLeft, typography.itemTitle);
...
export const SETTING_ROW_PRESSABLE =
	mergeStylexClassName("data-[popup-open]:bg-hover", sx.cursorPointer, sx.selectNone, sx.hoverBgHover);
...
export const SETTING_GLYPH =
	mergeStylexClassName("", sx.flex, sx.size4, sx.shrink0, sx.itemsCenter, sx.justifyCenter, sx.textDim);
