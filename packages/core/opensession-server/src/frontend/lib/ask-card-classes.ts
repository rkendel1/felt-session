...
export const ASK_CARD_SHELL =
	mergeStylexClassName("", sx.mxAuto, sx.mb6, sx.mt2, sx.flex, sx.wFull, sx.maxWVarSessionCol, sx.flexCol, sx.gap5, sx.roundedXl, sx.bgRaised, sx.p4, sx.CornerShapeVarCs);

export const ASK_CHOICE_ROW_BASE =
	mergeStylexClassName("group", sx.relative, sx.flex, sx.minH11, sx.wFull, sx.selectNone, sx.itemsStart, sx.gap3, sx.roundedCalc12pxVarRf, sx.bgControl, sx.px3, sx.py25, sx.textLeft, sx.CornerShapeVarCs);
