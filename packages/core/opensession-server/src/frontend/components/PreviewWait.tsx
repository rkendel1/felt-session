		...
		<div {...stylex.props(sx.fixed, sx.inset0, sx.flex, sx.flexCol, sx.itemsCenter, sx.justifyCenter, sx.gap4, sx.bgSurface, sx.px6, sx.textCenter)}>
			...
			{state === "waiting" ? (
				<>
					...
					{who && (
						<div {...stylex.props(sx.maxWSm, sx.truncate, sx.fontSemibold, sx.textDim, typography.label)}>
							{who}
						</div>
					)}
					<div {...stylex.props(sx.maxWSm, sx.fontMedium, sx.leadingRelaxed, sx.textDim, typography.label)}>
