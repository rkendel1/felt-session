...
export function metadataModelLabel(effectiveModel: string, models: ModelOption[]): string {
...
export function switchDividerText(model: string, from?: string, by?: string): string {
