...
export const popupSurfaceClasses =
	mergeStylexClassName("smooth-shadow-ring-md data-[starting-style]:scale-[0.97] data-[starting-style]:opacity-0 data-[ending-style]:opacity-0", sx.minW180px, sx.overflowHidden, sx.roundedPopup, sx.CornerShapeSquircle, sx.bgPopupGlass, sx.BackdropFilterVarPopupBlur, sx.SmoothRingColorVarPopupRing, sx.outlineNone, sx.originVarTransformOrigin, sx.transitionTransformOpacity, sx.duration120ms, sx.easeOut);

/** The scroller inside the surface: a long list scrolls, the padding stays. */
export const popupScrollClasses =
	mergeStylexClassName("", sx.maxHMin60vh420pxVarAvailableHeight, sx.overflowYAuto, sx.overflowXHidden, sx.overscrollContain, sx.p15);
...
export const popupItemClasses =
	mergeStylexClassName("data-[highlighted]:bg-hover", sx.flex, sx.wFull, sx.cursorPointer, sx.selectNone, sx.itemsCenter, sx.gap2, sx.roundedMd, sx.px2, sx.py15, sx.textLeft, typography.controlLabel, sx.textFg, sx.noUnderline, sx.outlineNone);
