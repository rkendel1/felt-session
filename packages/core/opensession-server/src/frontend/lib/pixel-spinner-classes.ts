...
export const PIXEL_GRID = mergeStylexClassName("", sx.grid, sx.gridCols3, sx.gapPx, sx.GlowColorCurrentColor);
...
const WAVE_BASE =
	mergeStylexClassName("", sx.AnimationNamePixelSnakeTrail, sx.AnimationTimingFunctionEaseOut, sx.AnimationIterationCountInfinite);
