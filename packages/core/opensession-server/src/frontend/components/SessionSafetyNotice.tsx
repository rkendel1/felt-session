...
export function SessionSafetyNotice({
  ...
  return (
    ...
    >
      ...
      {repairError && (
        <p role="alert" {...stylex.props(sx.mt3, sx.textRed, typography.supporting)}>
          {repairError}
        </p>
      )}
      <div {...mergeStylexProps("phone:flex-col phone:items-stretch", sx.mt4, sx.flex, sx.flexWrap, sx.itemsCenter, sx.gap2)} >
