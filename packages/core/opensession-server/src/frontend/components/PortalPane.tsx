...
export function PortalPane({ target }: { target: PortalTarget }) {
	...
	return (
		<div {...stylex.props(sx.flex, sx.hFull, sx.minH0, sx.flexCol, sx.bgPanel)}>
			<div {...stylex.props(sx.flex, sx.minH11, sx.itemsCenter, sx.gap2, sx.borderB, sx.borderDivider, sx.px3, sx.py15)}>
				<span {...stylex.props(sx.h2, sx.w2, sx.shrink0, sx.roundedFull, sx.bgGreen)} aria-hidden="true" />
				<div
			...
			<div {...stylex.props(sx.relative, sx.minH0, sx.flex1, sx.bgWhite)}>
				...
				<iframe
					...
					{...stylex.props(sx.block, sx.hFull, sx.wFull, sx.border0, sx.bgWhite)}
					src={target.url}
