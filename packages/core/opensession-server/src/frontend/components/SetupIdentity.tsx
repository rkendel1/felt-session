...
const IDENTITY_INPUT_CLASS = cn(settingsInputClass, utilityClassName("w-[140px] max-w-full"));
		...
		return (
			<Field label={<span {...stylex.props(sx.textFg)}>Agent name</span>}>
				<IdentityInput
					...
					className={mergeStylexOverrideClassName("", sx.h12, sx.minH12, sx.wFull, sx.px35, sx.textBase)}
				/>
				<span
