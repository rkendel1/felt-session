...
export const DEFAULT_WORKSPACE_MODEL_SETTINGS: WorkspaceModelSettings = {
  presets: [
    { id: "role-architect", label: "Architect", group: "roles", lead: { model: "pi/anthropic/claude-fable-5", effort: "high" }, instructions: "Act as the software architect. Investigate the repository, identify constraints and risks, and produce a concrete implementation design. Do not edit code unless explicitly asked to move into implementation." },
    { id: "role-researcher", label: "Researcher", group: "roles", lead: { model: "pi/openai/gpt-5.6-sol", effort: "high" }, instructions: "Act as the research agent. Investigate the question using the available sources and tools, distinguish evidence from inference, and return findings with useful attribution. Do not turn the work into a coding task unless explicitly asked." },
    { id: "role-planner", label: "Planner", group: "roles", lead: { model: "pi/anthropic/claude-fable-5", effort: "high" }, instructions: "Act as the planning agent. Clarify the outcome, identify dependencies and decisions, and produce an actionable plan. Planning may be the final deliverable; do not implement unless explicitly asked." },
    ...
    { id: "role-reviewer", label: "Reviewer", group: "roles", lead: { model: "pi/openai/gpt-5.6-sol", effort: "xhigh" }, instructions: "Act as an independent code reviewer. Inspect the actual diff and surrounding behavior for correctness, regressions, security, and maintainability. Do not modify code unless explicitly asked to fix findings." },
    ...
    { id: "role-release", label: "Release", group: "roles", lead: { model: "pi/openai/gpt-5.6-sol", effort: "high" }, instructions: "Act as the release engineer. Verify the target revision, required checks, rollout procedure, health signals, and rollback path before promoting it." },
    { id: "role-github", label: "GitHub agent", group: "roles", lead: { model: "pi/openai/gpt-5.6-sol", effort: "high" }, instructions: "Act as the GitHub agent. Work through the configured GitHub integration, preserve repository scope and publication policy, and manage issues, pull requests, reviews, and checks requested by the user." },
