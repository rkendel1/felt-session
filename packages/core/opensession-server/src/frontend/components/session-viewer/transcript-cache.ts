...
export function cachedTranscriptView(sessionId: string): CachedTranscriptView | null {
...
export function peekCachedTranscriptView(sessionId: string): CachedTranscriptView | null {
	return transcriptViewCache.get(sessionId) ?? null;
}

export function cacheTranscriptView(sessionId: string, view: CachedTranscriptView) {
	transcriptViewCache.delete(sessionId);
