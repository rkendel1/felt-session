	...
	return (
		<div {...stylex.props(sx.flex, sx.hFull, sx.minH0, sx.flexCol)}>
			...
			{url ? (
				<iframe
					key={`${url}#${reloadNonce}`}
					{...stylex.props(sx.block, sx.minH0, sx.wFull, sx.flex1, sx.border0, sx.bgWhite)}
					src={url}
				...
				<div {...stylex.props(sx.flex, sx.flex1, sx.flexCol, sx.itemsCenter, sx.justifyCenter, sx.gap3, sx.textCenter)}>
					...
					<div {...stylex.props(sx.maxWSm, sx.fontMedium, sx.leadingRelaxed, sx.textDim, typography.supporting)}>
